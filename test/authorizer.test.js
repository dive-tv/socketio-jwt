...
describe('authorizer without required login', function () {
  ...
  describe('when the user is not logged in and not token is provided', function () {

    it('should do the handshake, connect and return null as token', function (done){
      var socket = io.connect('http://localhost:9000', {
        'forceNew': true
      });

      socket.on('connect', function(){
        socket.on('echo-token-response', function (data) {
